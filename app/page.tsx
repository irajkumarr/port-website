    ...
    <div className="min-h-screen bg-gray-950 text-white ambient-glow-bg">
      ...
      <header className="relative flex justify-between items-center px-4 py-4 md:px-8 md:py-6 backdrop-blur-sm">
        <Link
          ...
          aria-label="Send email to Raj Kumar Timalsina at rajk.timalsina05@gmail.com"
        >
        ...
        <nav
          className="flex items-center space-x-4 text-sm md:space-x-6"
        ...
        >
          ...
          <div className="relative">
            ...
            <a
              ...
              aria-label="Download Raj Kumar Timalsina's Resume PDF"
            >
              <span>Resume</span>
            ...
            <button
              ...
              aria-haspopup="true"
              aria-label="Toggle Resume options dropdown"
            >
              <span>Resume</span>
              <svg
      ...
      <main className="relative px-4 py-8 md:px-8 md:py-12 max-w-7xl mx-auto z-[0]">
        {/* Hero Section */}
        <section
          className="flex flex-col lg:flex-row items-start justify-between mb-12 md:mb-20"
            ...
            <div className="flex flex-wrap gap-3">
              {socialLinks.map((social) => (
                <Link
                  ...
                  aria-label={`Visit Raj Kumar Timalsina's ${social.name} profile`}
                >
            ...
            <div className="relative group/avatar cursor-pointer">
              <div className="w-64 h-64 sm:w-72 sm:h-72 rounded-full overflow-hidden p-1 bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 transition-transform duration-500 group-hover/avatar:scale-105 shadow-xl shadow-purple-500/10">
                <div className="w-full h-full rounded-full overflow-hidden bg-gray-900 flex items-center justify-center">
                  <Image
                    src="./user-image.png"
                    alt="Raj Kumar Timalsina - Professional Flutter Developer & Full Stack Mobile Developer Nepal"
                    width={288}
                    height={288}
                    priority
        ...
        <section
          ...
          aria-label="Latest Flutter & Full Stack Projects"
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            {projects.map((project, index) => (
              <article key={index}>
                <Card className="bg-gray-900/40 border-gray-800/80 hover:border-blue-500/40 transition-all duration-300 hover:transform hover:scale-105 backdrop-blur-sm relative overflow-hidden group h-full">
                  ...
                  <CardContent className="p-4 md:p-6 relative z-10 flex flex-col h-full justify-between">
                    ...
                    {project.url ? (
                      <Link
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-block mt-auto w-fit"
                        aria-label={`View repository for project ${project.title}`}
                      >
                        <Button
                          variant="ghost"
                          size="sm"
                      ...
                      <Button
                        variant="ghost"
                        size="sm"
                        className="text-blue-400 hover:text-cyan-300 p-0 text-xs md:text-sm cursor-pointer mt-auto w-fit"
        ...
        <section className="text-center" aria-label="Contact and Collaboration">
          <div className="bg-gradient-to-br from-gray-900/40 to-neutral-900/40 rounded-2xl p-8 md:p-12 backdrop-blur-sm border border-gray-800/80 hover:border-blue-500/20 transition-all duration-500">
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center mb-6 md:mb-8">
              <a
                href="mailto:rajk.timalsina05@gmail.com"
                aria-label="Send email to Raj Kumar Timalsina"
              >
                <Button
                  size="lg"
            ...
            <div className="flex justify-center space-x-4 md:space-x-6">
              {socialLinks.map((social) => (
                <Link
                  ...
                  aria-label={`Follow Raj Kumar Timalsina on ${social.name}`}
                >
                  <social.icon
      ...
      {/* Footer Element */}
      <footer className="py-8 border-t border-gray-900/50 text-center text-xs text-gray-500 hidden">
        <p>
          © {new Date().getFullYear()} Raj Kumar Timalsina. All rights reserved.
        </p>
        <p className="mt-1 text-gray-600">
          Professional Flutter Developer | Full Stack Mobile Developer Nepal
        </p>
      </footer>
    </div>
  );
